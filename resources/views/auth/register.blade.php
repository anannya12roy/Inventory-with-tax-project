@extends('layouts.app', ['class' => 'register-page', 'page' => 'Inventory Management System', 'contentClass' => 'register-page', 'section' => 'auth'])
        ...
        <div class="col-md-7 ml-auto mr-auto">
            <div class="card card-register card-white">
                <div class="card-header">
                    <img class="card-img" src="{{ asset('assets') }}/img/register.png" alt="Card image" style="margin-bottom: 300px; width: 1200px; height: 220px"><br><br><br><br>
